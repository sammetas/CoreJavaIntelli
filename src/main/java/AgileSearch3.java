...
Input
Input contains of up to  hiking trips. Each trip is given as a line in the input. The line starts with , the number of items they need to split. Then follows the weight of each item. The weights are all in the range of [100,600]  grams. End of input is indicated by a line containing a single .
